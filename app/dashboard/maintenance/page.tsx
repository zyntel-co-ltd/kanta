...
> = {
  overdue: {
    activeBtn: "bg-red-600 text-white shadow-lg shadow-red-500/20",
    inactiveBtn: "bg-white border border-red-200 text-red-700 hover:bg-red-50",
    inactiveBadge: "bg-red-100 text-red-700",
  },
  upcoming: {
    activeBtn: "bg-amber-600 text-white shadow-lg shadow-amber-500/20",
    inactiveBtn: "bg-white border border-amber-200 text-amber-700 hover:bg-amber-50",
    inactiveBadge: "bg-amber-100 text-amber-700",
  },
  "in-progress": {
    activeBtn: "bg-emerald-600 text-white shadow-lg shadow-emerald-500/20",
    inactiveBtn: "bg-white border border-emerald-200 text-emerald-700 hover:bg-emerald-50",
    inactiveBadge: "bg-emerald-100 text-emerald-700",
  },
};
        ...
        {tabConfig.map(({ id, label, count, icon: Icon }) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
              tab === id ? tabButtonStyles[id].activeBtn : tabButtonStyles[id].inactiveBtn
            }`}
          >
            <Icon size={16} />
            {label}
            <span
              className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                tab === id ? "bg-white/20" : tabButtonStyles[id].inactiveBadge
              }`}
            >
              {count}
            </span>
